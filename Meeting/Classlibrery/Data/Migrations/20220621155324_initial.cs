        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPhotos_AspNetUsers_EntityId",
                        column: x => x.EntityId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserPhotos_AspNetUsers_UploaderID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cenceld = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Guides_Hobbies_HobbyId",
                        column: x => x.HobbyId,
                        principalTable: "Hobbies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhotosHobby", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PhotosHobby_AspNetUsers_UploaderID",
                        column: x => x.UploaderID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PhotosHobby_Hobbies_EntityId",
                        column: x => x.EntityId,
                        principalTable: "Hobbies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhotosEvent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PhotosEvent_AspNetUsers_UploaderID",
                        column: x => x.UploaderID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PhotosEvent_Events_EntityId",
                        column: x => x.EntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhotosEvent_EntityId",
                table: "PhotosEvent",
                column: "EntityId");

            migrationBuilder.CreateIndex(
                name: "IX_PhotosEvent_UploaderID",
                table: "PhotosEvent",
                column: "UploaderID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhotosHobby_UploaderID",
                table: "PhotosHobby",
                column: "UploaderID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPhotos_EntityId",
                table: "UserPhotos",
                column: "EntityId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserPhotos_UploaderID",
                table: "UserPhotos",
                column: "UploaderID");
        }
