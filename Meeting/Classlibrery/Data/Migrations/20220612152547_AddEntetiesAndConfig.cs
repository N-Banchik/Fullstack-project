...
{
    public partial class AddEntetiesAndConfig : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryHobby", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoryHobby_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryHobby_Hobbies_HobbyId",
                        column: x => x.HobbyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryHobby_CategoryId",
                table: "CategoryHobby",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoryHobby_HobbyId",
                table: "CategoryHobby",
                column: "HobbyId");
